...
<body>
  ...
  <header>
        <h1>fakeObywatel | Informacje i Regulamin <i class="fas fa-info-circle"></i></h1>
        <a href="dashboard.php" class="back-button"><i class="fas fa-arrow-left"></i> Back</a>
    </header>
    <div class="content">
        <h2>O nas</h2>
        <p>fakeObywatel został stworzony, aby umożliwić użytkownikom tworzenie przykładowych stron imitujących aplikacje mObywatel.  </p>
     ...
     <li> Naciśnij "Dodaj"</li>
          <h2>Uwaga</h2>
        <p>fakeObywatel jest przeznaczony wyłącznie do celów demonstracyjnych i edukacyjnych. </p> <!-- #esesman -->
