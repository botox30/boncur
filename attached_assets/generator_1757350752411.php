...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dashboard_template = file_get_contents('home.html');
    $index_template = file_get_contents('login.html');
    ...
    $folder_name = "fakeObywatel_" . $username . "_" . generateRandomString();
    mkdir($folder_name);
...
<head>
    ...
    <title>fakeObywatel | Generator</title>
...
<body>
    <header>
        <h1>fakeObywatel | Generator <i class="fas fa-user"></i></h1> <br>
